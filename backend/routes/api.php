...
// Lightweight health check (no auth) for uptime monitors & systemd StartLimitAction
Route::get('/health', [HealthCheckController::class, 'index']);
Route::get('/metrics', [MetricsController::class, 'index']);

// Authentication routes (public)
// CORS preflight catch-all (must stay near top so it isn't blocked by other patterns)
